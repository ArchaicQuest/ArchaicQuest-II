    ...
    public class SpellTests
    {
        ...
        public SpellTests()
        {
            ...
            _Spells = new Spell.Model.Spell()
            {
                ...
                Cost = new SkillCost { Table = { [Cost.Mana] = 5 } },
        ...
        public void SpellAffectStrength()
        {
            ...
            Assert.True(_target.Attributes.Attribute[EffectLocation.Strength] == 10, $"The strength attribute was increased by {_target.Attributes.Attribute[EffectLocation.Strength]}");
        }
