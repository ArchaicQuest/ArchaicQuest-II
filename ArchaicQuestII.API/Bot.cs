...
public class Bot
{
    ...
    public async Task MainAsync()
    {
        ...
        {
            GatewayIntents =
                GatewayIntents.AllUnprivileged | GatewayIntents.MessageContent | GatewayIntents.All
        };
    ...
    private async Task ClientOnMessageReceived(SocketMessage socketMessage)
    {
        await Task.Run(async () =>
        {
            ...
            if (!socketMessage.Author.IsBot)
            {
                ...
                var discordBotdata = new DiscordBotData()
                {
                    Channel = "",
                    Message = message,
                    Username = username
    ...
    public async Task PostToNewbieChannel(DiscordBotData data)
    {
        ...
        {
            message =
                $"<p class='gossip'>[<span>Gossip</span>] {data.Username}: {data.Message}</p>";
        }
