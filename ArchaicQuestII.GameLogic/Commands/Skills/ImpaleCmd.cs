...
namespace ArchaicQuestII.GameLogic.Commands.Skills
{
    ...
    {
        public ImpaleCmd(ICore core): base (core)
        {
        ...
        public void Execute(Player player, Room room, string[] input)
        {
            ...
            {
                Core.Writer.WriteLine("Impale What!?.", player.ConnectionId);
                return;
            }
            ...
            { 
                ...
                Core.Writer.WriteLine(Helpers.SkillLearnMistakes(player, DefineSkill.Impale().Name, Core.Gain), player.ConnectionId);
                player.Lag += 1;
                return;
            }
