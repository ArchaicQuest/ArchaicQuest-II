...
{
    public static void LoopCombats(ICoreHandler coreHandler)
    {
        var players = coreHandler.Combat.GetCombatList();
        ...
        foreach (var player in validPlayers)
        {
            ...
            {
                coreHandler.Combat.Fight(player, player.Target, coreHandler.World.GetRoom(player.RoomId),
                    false);
            }
