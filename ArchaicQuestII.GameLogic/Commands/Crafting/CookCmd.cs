...
{
    public CookCmd(ICoreHandler coreHandler)
    {
        Aliases = new[] {"Cook"};
    ...
    public void Execute(Player player, Room room, string[] input)
    {
        ...
        {
            Handler.Client.WriteLine("<p>You require a fire and a cooking pot before you can cook.</p>",
                player.ConnectionId);
        ...
        if (items.Count < 3)
        {
            Handler.Client.WriteLine("<p>You need 3 raw ingredients before you can cook.</p>",
                player.ConnectionId);
                
            if (pot.Container.Items.FirstOrDefault(x => x.ItemType != Item.Item.ItemTypes.Food) != null)
            {
                Handler.Client.WriteLine("<p>The following ingredients cannot be cooked with.</p>",
                    player.ConnectionId);
                ...
                Handler.Client.WriteLine(sb.ToString(),
                    player.ConnectionId);
        ...
        if (items.Count > 3)
        {
            Handler.Client.WriteLine("<p>You can only cook with 3 raw food ingredients. The following ingredients are not raw food and can't be cooked.</p>",
                player.ConnectionId);
        ...
        {
            Handler.Client.WriteLine("<p>You can only cook with 3 raw ingredients. The following ingredients cannot be cooked with.</p>",
                player.ConnectionId);
        ...
        Handler.Client.WriteLine("<p>You begin cooking.</p>",
            player.ConnectionId);
        Handler.Client.WriteLine("<p>You stir the ingredients.</p>",
            player.ConnectionId, 1000);

        Handler.Client.WriteLine("<p>You taste and season the dish.</p>",
        ...
        if (success)
        {
            ...
            {
                Handler.Client.WriteLine($"<p>{player.Name} has cooked {cookedItem.Name}</p>",
        ...
        else
        {
            ...
            foreach (var pc in room.Players.Where(pc => pc.Name != player.Name))
            {
                Handler.Client.WriteLine($"<p>{player.Name} fails to cook {cookedItem.Name}</p>",
                    pc.ConnectionId, 6000);
            }

            Handler.Character.SkillLearnMistakes(player, "Cooking", 6000);
        }
    ...
    private int CalculateModifer(IOrderedEnumerable<Tuple<Item.Item, int>> ingredients, string name)
    {
        ...
        {
            case "strength":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Strength,
                ...
                break;
            case "dexterity":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Dexterity,
                ...
                break;
            case "constitution":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Constitution,
                ...
                break;
            case "intelligence":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Intelligence,
                ...
                break;
            case "wisdom":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Wisdom,
                ...
                break;
            case "charisma":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Charisma,
                ...
                break;
            case "damroll":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.DamRoll,
                ...
                break;
            case "hitroll":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.HitRoll,
                ...
                break;
            case "mana":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Mana,
                ...
                break;
            case "moves":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Moves,
                ...
                break;
            case "hp":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.HP,
                ...
                break;
            case "saves":
                modValue = DiceBag.Roll(1, mainIngredient.Item1.Modifier.Saves,
