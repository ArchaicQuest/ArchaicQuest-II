...
namespace ArchaicQuestII.GameLogic.Core
{
    public class Weather : IWeather
    {
        ...
        public List<Tuple<string, string>> sunnyToCloudyTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
                "The sky is blue with a few wispy clouds.",
                "The sky is dark with a few wispy clouds."
            ),
            new Tuple<string, string>(
        ...
        public List<Tuple<string, string>> cloudyToSunnyTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
        ...
        public List<Tuple<string, string>> cloudyToRainyTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
                "The clouds appear darker in the sky.",
                "The clouds appear darker in the night sky."
            ),
            new Tuple<string, string>(
        ...
        public List<Tuple<string, string>> LightRainToCloudTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
        ...
        public List<Tuple<string, string>> LightRainToHeavyRainTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
        ...
        public List<Tuple<string, string>> HeavyRainToLightRainTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
        ...
        public List<Tuple<string, string>> HeavyRainToThunderTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
        ...
        public List<Tuple<string, string>> ThunderToLightRainTransitionStates = new List<
            Tuple<string, string>
        >()
        {
            new Tuple<string, string>(
        ...
        public string SimulateWeatherTransitions()
        {
            ...
            var sunnyStates = new List<Tuple<string, string>>()
            {
                new Tuple<string, string>(
                    ...
                    "It's a beautiful clear night sky with twinkling stars"
                ),
                new Tuple<string, string>(
            ...
            {
                weatherText = Services.Instance.Time.IsNightTime()
                    ? CloudyStates[0].Item1
                    : CloudyStates[0].Item2;
            ...
            {
                weatherText = Services.Instance.Time.IsNightTime()
                    ? LightRainState[DiceBag.Roll(1, 0, 1)].Item1
                    : LightRainState[DiceBag.Roll(1, 0, 1)].Item2;
            ...
            {
                weatherText = Services.Instance.Time.IsNightTime()
                    ? HeavyRainState[DiceBag.Roll(1, 0, 1)].Item1
                    : HeavyRainState[DiceBag.Roll(1, 0, 1)].Item2;
            ...
            {
                weatherText = Services.Instance.Time.IsNightTime()
                    ? ThunderState[DiceBag.Roll(1, 0, 2)].Item1
                    : ThunderState[DiceBag.Roll(1, 0, 2)].Item2;
            ...
            {
                weatherText = WeatherTransition(
                    "Cloudy",
                    sunnyToCloudyTransitionStates,
                    ref SunnyToCloudyTransitionState
                );
            ...
            if (WeatherState == "CloudyToSunny")
            {
                weatherText = WeatherTransition(
                    "Sunny",
                    cloudyToSunnyTransitionStates,
                    ref CloudyToSunnyTransitionState
                );
            ...
            if (WeatherState == "CloudyToRain")
            {
                weatherText = WeatherTransition(
                    "LightRain",
                    cloudyToRainyTransitionStates,
                    ref CloudyToLightRainTransitionState
                );
            ...
            if (WeatherState == "RainToCloudy")
            {
                weatherText = WeatherTransition(
                    "Cloudy",
                    LightRainToCloudTransitionStates,
                    ref LightRainToCloudyTransitionState
                );
            ...
            if (WeatherState == "RainToHeavyRain")
            {
                weatherText = WeatherTransition(
                    "HeavyRain",
                    LightRainToHeavyRainTransitionStates,
                    ref LightRainToHeavyRainTransitionState
                );
            ...
            if (WeatherState == "HeavyToLightRain")
            {
                weatherText = WeatherTransition(
                    "LightRain",
                    HeavyRainToLightRainTransitionStates,
                    ref HeavyRainToLightRainTransitionState
                );
            ...
            if (WeatherState == "HeavyRainToThunder")
            {
                weatherText = WeatherTransition(
                    "Thunder",
                    HeavyRainToThunderTransitionStates,
                    ref HeavyRainToThunderTransitionState
                );
            ...
            if (WeatherState == "ThunderToLightRain")
            {
                weatherText = WeatherTransition(
                    "LightRain",
                    ThunderToLightRainTransitionStates,
                    ref ThunderToLightRainTransitionState
                );
            ...
            return Services.Instance.Time.IsNightTime()
                ? "It's a beautiful clear blue sky"
                : "It's a beautiful clear night sky";
        }

        public string WeatherTransition(
            string NewState,
            List<Tuple<string, string>> transitions,
            ref int transitionCount
        )
        {
            var weatherText = Services.Instance.Time.IsNightTime()
                ? transitions[transitionCount].Item1
                : transitions[transitionCount].Item2;
            transitionCount += 1;
