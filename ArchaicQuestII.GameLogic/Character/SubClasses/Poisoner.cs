...
public class Poisoner : IClass
{
    public int Id { get; set; }
    public bool IsSubClass => true;
    public string Name => SubClassName.Poisoner.ToString();
    public string Description => "Poisoner";

    public string PreferredWeapon => SkillName.ShortBlades.ToString();
