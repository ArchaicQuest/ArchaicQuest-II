...
public class Engineer : IClass
{
    public int Id { get; set; }
    public bool IsSubClass => true;
    public string Name => SubClassName.Engineer.ToString();
    public string Description => "Engineer";

    public string PreferredWeapon => SkillName.Blunt.ToString();
