    ...
    internal static class Races
    {
        private static readonly List<Race> seedData = new List<Race>()
        {
            new Race()
            {
                ...
                CreatedBy = "Malleus",
                Description =
                    @"`Humans are highly adaptable and the most common race in the world.
They come in a wide range of skin, eye and hair colours as well as different shapes and sizes.",
            ...
            new Race()
            {
                ...
                Playable = true,
                Description =
                    @"`Elves are shorter and slimmer than humans, they are also more in tune with nature and magic.
            ...
            new Race()
            {
                ...
                Playable = true,
                Description =
                    @"`Dark Elves are identical to their elven brethren except their skin ranges from dark pale blue to black.
            ...
            new Race()
            {
                ...
                Playable = true,
                Description =
                    @"`Dwarves are a short muscular humanoids who prefer the mountains and the underdark where they enjoy
        ...
        {
            if (!Services.Instance.DataBase.DoesCollectionExist(DataBase.Collections.Race))
            {
                foreach (var raceSeed in seedData)
                {
                    Services.Instance.DataBase.Save(raceSeed, DataBase.Collections.Race);
                }
            }
        }
    }
